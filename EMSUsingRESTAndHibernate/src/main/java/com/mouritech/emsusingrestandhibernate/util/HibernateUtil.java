package com.mouritech.emsusingrestandhibernate.util;
	...
	public static SessionFactory getSessionFactory() {
		if(sessionFactory == null) {
			try {
				...
				settings.put(Environment.URL,"jdbc:mysql://localhost:3306/hibernate_mouritech");
				settings.put(Environment.USER, "root");
				settings.put(Environment.PASS,"Salunkhe-123");
